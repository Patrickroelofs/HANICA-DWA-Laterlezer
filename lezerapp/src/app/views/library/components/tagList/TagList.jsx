...
function TagList() {
  ...
  const tagList = tags.map((tag, index) => (
    <li key={tag.title} className={`overflow-hidden transform hover:scale-105 hover:bg-gray-100 motion-reduce:transform-none transition-transform rounded-lg my-1 ${selectedTags.includes(tag.title) ? 'bg-gray-200' : null}`}>
